	...
	var FormatPopup = (this.FormatPopup = this.Popup.extend({
		...
		initialize: function (data) {
			...
			if (!this.open) {
				...
				this.open = Storage.prefs("openformats") || {
					...
					"National Dex": true,
					"OM of the Month": true,
					"Other Metagames": true,
					"Randomized Format Spotlight": true,
					"RoA Spotlight": true,
					// For AFD
			...
			if (!this.selectType)
				this.selectType = this.sourceEl.closest("form").data("search")
					? "search"
					: "challenge";
		...
		selectFormat: function (format) {
			if (this.onselect) {
				...
				var $bestOfCheckbox = this.sourceEl
					.closest("form")
					.find("input[name=bestof]");
				var $bestOfValueInput = this.sourceEl
					.closest("form")
					.find("input[name=bestofvalue]");
				...
				var $teraPreviewCheckbox = this.sourceEl
					.closest("form")
					.find("input[name=terapreview]");
